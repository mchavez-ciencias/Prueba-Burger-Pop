...
$gloreya_blog_sidebar = gloreya_option('blog_sidebar',3); 

$gloreya_column = ($gloreya_blog_sidebar == 1 || !is_active_sidebar('sidebar-1')) ? 'col-lg-8 mx-auto' : 'col-lg-8 col-md-12';
?>
			...
			<div class="<?php echo esc_attr($gloreya_column);?>">
				<?php if ( have_posts() ) : ?>
					<div class="xs-page-header">
                        <h2>
							<?php printf(esc_html__('Search Results for: %s', 'gloreya'), get_search_query()); ?>
                        </h2>
                        <?php
