...
class Control_Image_Choose extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_register_style( 'image-choose-control',  GLOREYA_CSS . '/image-choose-control.css', [], '1.0.0' );
		wp_enqueue_style( 'image-choose-control' );

		// script	
		wp_register_script( 'image-choose-control',  GLOREYA_JS . '/image-choose-control.js' );
