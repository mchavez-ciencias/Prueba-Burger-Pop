 ...
 * @since 1.0.0
 */
class Gloreya_Icon_Controler extends Elementor\Base_Data_Control {
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				...
				<select class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php esc_attr_e( 'Select Icon', 'gloreya' ); ?>">

					<option value=""><?php esc_html_e( 'Select Icon', 'gloreya' ); ?></option>
