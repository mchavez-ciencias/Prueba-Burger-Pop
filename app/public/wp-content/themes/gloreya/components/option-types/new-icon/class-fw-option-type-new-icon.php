...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = GLOREYA_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( GLOREYA_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'gloreya' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'gloreya' ),
					'hand'				 => esc_html__( 'Hand Icons', 'gloreya' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'gloreya' ),
					'gender'			 => esc_html__( 'Gender Icons', 'gloreya' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'gloreya' ),
					'payment'			 => esc_html__( 'Payment Icons', 'gloreya' ),
					'currency'			 => esc_html__( 'Currency Icons', 'gloreya' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'gloreya' ),
					'directional'		 => esc_html__( 'Directional Icons', 'gloreya' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'gloreya' ),
					'brand'				 => esc_html__( 'Brand Icons', 'gloreya' ),
					'medical'			 => esc_html__( 'Medical Icons', 'gloreya' ),
					'gloreya-icons'	 => esc_html__( 'Gloreya Icons', 'gloreya' ),
				),
				'icons'				 => array(
					...
					//gloreya Icons
               'icon icon-title' => array('group' => 'gloreya-icons'),
               'icon icon-feature_icon11' => array('group' => 'gloreya-icons'),
               'icon icon-feature_icon1' => array('group' => 'gloreya-icons'),
               'icon icon-feature_icon21' => array('group' => 'gloreya-icons'),
               'icon icon-feature_icon2' => array('group' => 'gloreya-icons'),
               'icon icon-feature_icon31' => array('group' => 'gloreya-icons'),
               'icon icon-feature_icon3' => array('group' => 'gloreya-icons'),
               'icon icon-funfact_icon1' => array('group' => 'gloreya-icons'),
               'icon icon-funfact_icon2' => array('group' => 'gloreya-icons'),
               'icon icon-funfact_icon3' => array('group' => 'gloreya-icons'),
               'icon icon-menu_icon1' => array('group' => 'gloreya-icons'),
               'icon icon-menu_icon2' => array('group' => 'gloreya-icons'),
               'icon icon-menu_icon3' => array('group' => 'gloreya-icons'),
               'icon icon-menu_icon4' => array('group' => 'gloreya-icons'),
               'icon icon-menu_icon5' => array('group' => 'gloreya-icons'),
               'icon icon-quote' => array('group' => 'gloreya-icons'),
               'icon icon-About-2' => array('group' => 'gloreya-icons'),
               'icon icon-About-3' => array('group' => 'gloreya-icons'),
               'icon icon-About-4' => array('group' => 'gloreya-icons'),
               'icon icon-About' => array('group' => 'gloreya-icons'),
               'icon icon-Banner_current' => array('group' => 'gloreya-icons'),
               'icon icon-Banner_factory-1' => array('group' => 'gloreya-icons'),
               'icon icon-Banner_factory' => array('group' => 'gloreya-icons'),
               'icon icon-Banner_pumpjack' => array('group' => 'gloreya-icons'),
               'icon icon-Funfacts-2' => array('group' => 'gloreya-icons'),
               'icon icon-Funfacts-3' => array('group' => 'gloreya-icons'),
               'icon icon-Funfacts-4' => array('group' => 'gloreya-icons'),
               'icon icon-Funfacts' => array('group' => 'gloreya-icons'),
               'icon icon-mobile' => array('group' => 'gloreya-icons'),
               'icon icon-laptop' => array('group' => 'gloreya-icons'),
               'icon icon-desktop' => array('group' => 'gloreya-icons'),
               'icon icon-tablet' => array('group' => 'gloreya-icons'),
               'icon icon-phone' => array('group' => 'gloreya-icons'),
               'icon icon-document' => array('group' => 'gloreya-icons'),
               'icon icon-documents' => array('group' => 'gloreya-icons'),
               'icon icon-search' => array('group' => 'gloreya-icons'),
               'icon icon-clipboard' => array('group' => 'gloreya-icons'),
               'icon icon-newspaper' => array('group' => 'gloreya-icons'),
               'icon icon-notebook' => array('group' => 'gloreya-icons'),
               'icon icon-book-open' => array('group' => 'gloreya-icons'),
               'icon icon-browser' => array('group' => 'gloreya-icons'),
               'icon icon-calendar' => array('group' => 'gloreya-icons'),
               'icon icon-presentation' => array('group' => 'gloreya-icons'),
               'icon icon-picture' => array('group' => 'gloreya-icons'),
               'icon icon-pictures' => array('group' => 'gloreya-icons'),
               'icon icon-video' => array('group' => 'gloreya-icons'),
               'icon icon-camera' => array('group' => 'gloreya-icons'),
               'icon icon-printer' => array('group' => 'gloreya-icons'),
               'icon icon-toolbox' => array('group' => 'gloreya-icons'),
               'icon icon-briefcase' => array('group' => 'gloreya-icons'),
               'icon icon-wallet' => array('group' => 'gloreya-icons'),
               'icon icon-gift' => array('group' => 'gloreya-icons'),
               'icon icon-bargraph' => array('group' => 'gloreya-icons'),
               'icon icon-grid' => array('group' => 'gloreya-icons'),
               'icon icon-expand' => array('group' => 'gloreya-icons'),
               'icon icon-focus' => array('group' => 'gloreya-icons'),
               'icon icon-edit' => array('group' => 'gloreya-icons'),
               'icon icon-adjustments' => array('group' => 'gloreya-icons'),
               'icon icon-ribbon' => array('group' => 'gloreya-icons'),
               'icon icon-hourglass' => array('group' => 'gloreya-icons'),
               'icon icon-lock' => array('group' => 'gloreya-icons'),
               'icon icon-megaphone' => array('group' => 'gloreya-icons'),
               'icon icon-shield' => array('group' => 'gloreya-icons'),
               'icon icon-trophy' => array('group' => 'gloreya-icons'),
               'icon icon-flag' => array('group' => 'gloreya-icons'),
               'icon icon-map' => array('group' => 'gloreya-icons'),
               'icon icon-puzzle' => array('group' => 'gloreya-icons'),
               'icon icon-basket' => array('group' => 'gloreya-icons'),
               'icon icon-envelope' => array('group' => 'gloreya-icons'),
               'icon icon-streetsign' => array('group' => 'gloreya-icons'),
               'icon icon-telescope' => array('group' => 'gloreya-icons'),
               'icon icon-gears' => array('group' => 'gloreya-icons'),
               'icon icon-key' => array('group' => 'gloreya-icons'),
               'icon icon-paperclip' => array('group' => 'gloreya-icons'),
               'icon icon-attachment' => array('group' => 'gloreya-icons'),
               'icon icon-pricetags' => array('group' => 'gloreya-icons'),
               'icon icon-lightbulb' => array('group' => 'gloreya-icons'),
               'icon icon-layers' => array('group' => 'gloreya-icons'),
               'icon icon-pencil' => array('group' => 'gloreya-icons'),
               'icon icon-tools' => array('group' => 'gloreya-icons'),
               'icon icon-tools-2' => array('group' => 'gloreya-icons'),
               'icon icon-scissors' => array('group' => 'gloreya-icons'),
               'icon icon-paintbrush' => array('group' => 'gloreya-icons'),
               'icon icon-magnifying-glass' => array('group' => 'gloreya-icons'),
               'icon icon-circle-compass' => array('group' => 'gloreya-icons'),
               'icon icon-linegraph' => array('group' => 'gloreya-icons'),
               'icon icon-mic' => array('group' => 'gloreya-icons'),
               'icon icon-strategy' => array('group' => 'gloreya-icons'),
               'icon icon-beaker' => array('group' => 'gloreya-icons'),
               'icon icon-caution' => array('group' => 'gloreya-icons'),
               'icon icon-recycle' => array('group' => 'gloreya-icons'),
               'icon icon-anchor' => array('group' => 'gloreya-icons'),
               'icon icon-profile-male' => array('group' => 'gloreya-icons'),
               'icon icon-profile-female' => array('group' => 'gloreya-icons'),
               'icon icon-bike' => array('group' => 'gloreya-icons'),
               'icon icon-wine' => array('group' => 'gloreya-icons'),
               'icon icon-hotairballoon' => array('group' => 'gloreya-icons'),
               'icon icon-globe' => array('group' => 'gloreya-icons'),
               'icon icon-genius' => array('group' => 'gloreya-icons'),
               'icon icon-map-pin' => array('group' => 'gloreya-icons'),
               'icon icon-dial' => array('group' => 'gloreya-icons'),
               'icon icon-chat' => array('group' => 'gloreya-icons'),
               'icon icon-heart' => array('group' => 'gloreya-icons'),
               'icon icon-cloud' => array('group' => 'gloreya-icons'),
               'icon icon-upload' => array('group' => 'gloreya-icons'),
               'icon icon-download' => array('group' => 'gloreya-icons'),
               'icon icon-target' => array('group' => 'gloreya-icons'),
               'icon icon-hazardous' => array('group' => 'gloreya-icons'),
               'icon icon-piechart' => array('group' => 'gloreya-icons'),
               'icon icon-speedometer' => array('group' => 'gloreya-icons'),
               'icon icon-global' => array('group' => 'gloreya-icons'),
               'icon icon-compass' => array('group' => 'gloreya-icons'),
               'icon icon-lifesaver' => array('group' => 'gloreya-icons'),
               'icon icon-clock' => array('group' => 'gloreya-icons'),
               'icon icon-aperture' => array('group' => 'gloreya-icons'),
               'icon icon-quote1' => array('group' => 'gloreya-icons'),
               'icon icon-scope' => array('group' => 'gloreya-icons'),
               'icon icon-alarmclock' => array('group' => 'gloreya-icons'),
               'icon icon-refresh' => array('group' => 'gloreya-icons'),
               'icon icon-happy' => array('group' => 'gloreya-icons'),
               'icon icon-sad' => array('group' => 'gloreya-icons'),
               'icon icon-facebook' => array('group' => 'gloreya-icons'),
               'icon icon-twitter' => array('group' => 'gloreya-icons'),
               'icon icon-googleplus' => array('group' => 'gloreya-icons'),
               'icon icon-rss' => array('group' => 'gloreya-icons'),
               'icon icon-tumblr' => array('group' => 'gloreya-icons'),
               'icon icon-linkedin' => array('group' => 'gloreya-icons'),
               'icon icon-dribbble' => array('group' => 'gloreya-icons'),
               'icon icon-home' => array('group' => 'gloreya-icons'),
               'icon icon-apartment' => array('group' => 'gloreya-icons'),
               'icon icon-pencil1' => array('group' => 'gloreya-icons'),
               'icon icon-magic-wand' => array('group' => 'gloreya-icons'),
               'icon icon-drop' => array('group' => 'gloreya-icons'),
               'icon icon-lighter' => array('group' => 'gloreya-icons'),
               'icon icon-poop' => array('group' => 'gloreya-icons'),
               'icon icon-sun' => array('group' => 'gloreya-icons'),
               'icon icon-moon' => array('group' => 'gloreya-icons'),
               'icon icon-cloud1' => array('group' => 'gloreya-icons'),
               'icon icon-cloud-upload' => array('group' => 'gloreya-icons'),
               'icon icon-cloud-download' => array('group' => 'gloreya-icons'),
               'icon icon-cloud-sync' => array('group' => 'gloreya-icons'),
               'icon icon-cloud-check' => array('group' => 'gloreya-icons'),
               'icon icon-database' => array('group' => 'gloreya-icons'),
               'icon icon-lock1' => array('group' => 'gloreya-icons'),
               'icon icon-cog' => array('group' => 'gloreya-icons'),
               'icon icon-trash' => array('group' => 'gloreya-icons'),
               'icon icon-dice' => array('group' => 'gloreya-icons'),
               'icon icon-heart1' => array('group' => 'gloreya-icons'),
               'icon icon-star' => array('group' => 'gloreya-icons'),
               'icon icon-star-half' => array('group' => 'gloreya-icons'),
               'icon icon-star-empty' => array('group' => 'gloreya-icons'),
               'icon icon-flag1' => array('group' => 'gloreya-icons'),
               'icon icon-envelope1' => array('group' => 'gloreya-icons'),
               'icon icon-paperclip1' => array('group' => 'gloreya-icons'),
               'icon icon-inbox' => array('group' => 'gloreya-icons'),
               'icon icon-eye' => array('group' => 'gloreya-icons'),
               'icon icon-printer1' => array('group' => 'gloreya-icons'),
               'icon icon-file-empty' => array('group' => 'gloreya-icons'),
               'icon icon-file-add' => array('group' => 'gloreya-icons'),
               'icon icon-enter' => array('group' => 'gloreya-icons'),
               'icon icon-exit' => array('group' => 'gloreya-icons'),
               'icon icon-graduation-hat' => array('group' => 'gloreya-icons'),
               'icon icon-license' => array('group' => 'gloreya-icons'),
               'icon icon-music-note' => array('group' => 'gloreya-icons'),
               'icon icon-film-play' => array('group' => 'gloreya-icons'),
               'icon icon-camera-video' => array('group' => 'gloreya-icons'),
               'icon icon-camera1' => array('group' => 'gloreya-icons'),
               'icon icon-picture1' => array('group' => 'gloreya-icons'),
               'icon icon-book' => array('group' => 'gloreya-icons'),
               'icon icon-bookmark' => array('group' => 'gloreya-icons'),
               'icon icon-user' => array('group' => 'gloreya-icons'),
               'icon icon-users' => array('group' => 'gloreya-icons'),
               'icon icon-shirt' => array('group' => 'gloreya-icons'),
               'icon icon-store' => array('group' => 'gloreya-icons'),
               'icon icon-cart' => array('group' => 'gloreya-icons'),
               'icon icon-tag' => array('group' => 'gloreya-icons'),
               'icon icon-phone-handset' => array('group' => 'gloreya-icons'),
               'icon icon-phone1' => array('group' => 'gloreya-icons'),
               'icon icon-pushpin' => array('group' => 'gloreya-icons'),
               'icon icon-map-marker' => array('group' => 'gloreya-icons'),
               'icon icon-map1' => array('group' => 'gloreya-icons'),
               'icon icon-location' => array('group' => 'gloreya-icons'),
               'icon icon-calendar-full' => array('group' => 'gloreya-icons'),
               'icon icon-keyboard' => array('group' => 'gloreya-icons'),
               'icon icon-spell-check' => array('group' => 'gloreya-icons'),
               'icon icon-screen' => array('group' => 'gloreya-icons'),
               'icon icon-smartphone' => array('group' => 'gloreya-icons'),
               'icon icon-tablet1' => array('group' => 'gloreya-icons'),
               'icon icon-laptop1' => array('group' => 'gloreya-icons'),
               'icon icon-laptop-phone' => array('group' => 'gloreya-icons'),
               'icon icon-power-switch' => array('group' => 'gloreya-icons'),
               'icon icon-bubble' => array('group' => 'gloreya-icons'),
               'icon icon-heart-pulse' => array('group' => 'gloreya-icons'),
               'icon icon-construction' => array('group' => 'gloreya-icons'),
               'icon icon-pie-chart' => array('group' => 'gloreya-icons'),
               'icon icon-chart-bars' => array('group' => 'gloreya-icons'),
               'icon icon-gift1' => array('group' => 'gloreya-icons'),
               'icon icon-diamond' => array('group' => 'gloreya-icons'),
               'icon icon-dinner' => array('group' => 'gloreya-icons'),
               'icon icon-coffee-cup' => array('group' => 'gloreya-icons'),
               'icon icon-leaf' => array('group' => 'gloreya-icons'),
               'icon icon-paw' => array('group' => 'gloreya-icons'),
               'icon icon-rocket' => array('group' => 'gloreya-icons'),
               'icon icon-briefcase1' => array('group' => 'gloreya-icons'),
               'icon icon-bus' => array('group' => 'gloreya-icons'),
               'icon icon-car' => array('group' => 'gloreya-icons'),
               'icon icon-train' => array('group' => 'gloreya-icons'),
               'icon icon-bicycle' => array('group' => 'gloreya-icons'),
               'icon icon-wheelchair' => array('group' => 'gloreya-icons'),
               'icon icon-select' => array('group' => 'gloreya-icons'),
               'icon icon-earth' => array('group' => 'gloreya-icons'),
               'icon icon-smile' => array('group' => 'gloreya-icons'),
               'icon icon-sad1' => array('group' => 'gloreya-icons'),
               'icon icon-neutral' => array('group' => 'gloreya-icons'),
               'icon icon-mustache' => array('group' => 'gloreya-icons'),
               'icon icon-alarm' => array('group' => 'gloreya-icons'),
               'icon icon-bullhorn' => array('group' => 'gloreya-icons'),
               'icon icon-volume-high' => array('group' => 'gloreya-icons'),
               'icon icon-volume-medium' => array('group' => 'gloreya-icons'),
               'icon icon-volume-low' => array('group' => 'gloreya-icons'),
               'icon icon-volume' => array('group' => 'gloreya-icons'),
               'icon icon-mic1' => array('group' => 'gloreya-icons'),
               'icon icon-hourglass1' => array('group' => 'gloreya-icons'),
               'icon icon-undo' => array('group' => 'gloreya-icons'),
               'icon icon-redo' => array('group' => 'gloreya-icons'),
               'icon icon-sync' => array('group' => 'gloreya-icons'),
               'icon icon-history' => array('group' => 'gloreya-icons'),
               'icon icon-clock1' => array('group' => 'gloreya-icons'),
               'icon icon-download1' => array('group' => 'gloreya-icons'),
               'icon icon-upload1' => array('group' => 'gloreya-icons'),
               'icon icon-enter-down' => array('group' => 'gloreya-icons'),
               'icon icon-exit-up' => array('group' => 'gloreya-icons'),
               'icon icon-bug' => array('group' => 'gloreya-icons'),
               'icon icon-code' => array('group' => 'gloreya-icons'),
               'icon icon-link' => array('group' => 'gloreya-icons'),
               'icon icon-unlink' => array('group' => 'gloreya-icons'),
               'icon icon-thumbs-up' => array('group' => 'gloreya-icons'),
               'icon icon-thumbs-down' => array('group' => 'gloreya-icons'),
               'icon icon-magnifier' => array('group' => 'gloreya-icons'),
               'icon icon-cross' => array('group' => 'gloreya-icons'),
               'icon icon-menu' => array('group' => 'gloreya-icons'),
               'icon icon-list' => array('group' => 'gloreya-icons'),
               'icon icon-chevron-up' => array('group' => 'gloreya-icons'),
               'icon icon-chevron-down' => array('group' => 'gloreya-icons'),
               'icon icon-chevron-left' => array('group' => 'gloreya-icons'),
               'icon icon-chevron-right' => array('group' => 'gloreya-icons'),
               'icon icon-arrow-up' => array('group' => 'gloreya-icons'),
               'icon icon-arrow-down' => array('group' => 'gloreya-icons'),
               'icon icon-arrow-left' => array('group' => 'gloreya-icons'),
               'icon icon-arrow-right' => array('group' => 'gloreya-icons'),
               'icon icon-move' => array('group' => 'gloreya-icons'),
               'icon icon-warning' => array('group' => 'gloreya-icons'),
               'icon icon-question-circle' => array('group' => 'gloreya-icons'),
               'icon icon-menu-circle' => array('group' => 'gloreya-icons'),
               'icon icon-checkmark-circle' => array('group' => 'gloreya-icons'),
               'icon icon-cross-circle' => array('group' => 'gloreya-icons'),
               'icon icon-plus-circle' => array('group' => 'gloreya-icons'),
               'icon icon-circle-minus' => array('group' => 'gloreya-icons'),
               'icon icon-arrow-up-circle' => array('group' => 'gloreya-icons'),
               'icon icon-arrow-down-circle' => array('group' => 'gloreya-icons'),
               'icon icon-arrow-left-circle' => array('group' => 'gloreya-icons'),
               'icon icon-arrow-right-circle' => array('group' => 'gloreya-icons'),
               'icon icon-chevron-up-circle' => array('group' => 'gloreya-icons'),
               'icon icon-chevron-down-circle' => array('group' => 'gloreya-icons'),
               'icon icon-chevron-left-circle' => array('group' => 'gloreya-icons'),
               'icon icon-chevron-right-circle' => array('group' => 'gloreya-icons'),
               'icon icon-crop' => array('group' => 'gloreya-icons'),
               'icon icon-frame-expand' => array('group' => 'gloreya-icons'),
               'icon icon-frame-contract' => array('group' => 'gloreya-icons'),
               'icon icon-layers1' => array('group' => 'gloreya-icons'),
               'icon icon-funnel' => array('group' => 'gloreya-icons'),
               'icon icon-text-format' => array('group' => 'gloreya-icons'),
               'icon icon-text-size' => array('group' => 'gloreya-icons'),
               'icon icon-bold' => array('group' => 'gloreya-icons'),
               'icon icon-italic' => array('group' => 'gloreya-icons'),
               'icon icon-underline' => array('group' => 'gloreya-icons'),
               'icon icon-strikethrough' => array('group' => 'gloreya-icons'),
               'icon icon-highlight' => array('group' => 'gloreya-icons'),
               'icon icon-text-align-left' => array('group' => 'gloreya-icons'),
               'icon icon-text-align-center' => array('group' => 'gloreya-icons'),
               'icon icon-text-align-right' => array('group' => 'gloreya-icons'),
               'icon icon-text-align-justify' => array('group' => 'gloreya-icons'),
               'icon icon-line-spacing' => array('group' => 'gloreya-icons'),
               'icon icon-indent-increase' => array('group' => 'gloreya-icons'),
               'icon icon-indent-decrease' => array('group' => 'gloreya-icons'),
               'icon icon-page-break' => array('group' => 'gloreya-icons'),
               'icon icon-hand' => array('group' => 'gloreya-icons'),
               'icon icon-pointer-up' => array('group' => 'gloreya-icons'),
               'icon icon-pointer-right' => array('group' => 'gloreya-icons'),
               'icon icon-pointer-down' => array('group' => 'gloreya-icons'),
               'icon icon-pointer-left' => array('group' => 'gloreya-icons'),
               'icon icon-vplay' => array('group' => 'gloreya-icons'),
               'icon icon-newsletter' => array('group' => 'gloreya-icons'),
               'icon icon-coins-2' => array('group' => 'gloreya-icons'),
               'icon icon-commerce-2' => array('group' => 'gloreya-icons'),
               'icon icon-monitor' => array('group' => 'gloreya-icons'),
               'icon icon-graphic-3' => array('group' => 'gloreya-icons'),
               'icon icon-business' => array('group' => 'gloreya-icons'),
               'icon icon-graphic-2' => array('group' => 'gloreya-icons'),
               'icon icon-commerce-1' => array('group' => 'gloreya-icons'),
               'icon icon-hammer' => array('group' => 'gloreya-icons'),
               'icon icon-graphic-1' => array('group' => 'gloreya-icons'),
               'icon icon-graphic' => array('group' => 'gloreya-icons'),
               'icon icon-justice-1' => array('group' => 'gloreya-icons'),
               'icon icon-line' => array('group' => 'gloreya-icons'),
               'icon icon-money-3' => array('group' => 'gloreya-icons'),
               'icon icon-chart' => array('group' => 'gloreya-icons'),
               'icon icon-commerce' => array('group' => 'gloreya-icons'),
               'icon icon-agenda' => array('group' => 'gloreya-icons'),
               'icon icon-money-2' => array('group' => 'gloreya-icons'),
               'icon icon-justice' => array('group' => 'gloreya-icons'),
               'icon icon-money-1' => array('group' => 'gloreya-icons'),
               'icon icon-money' => array('group' => 'gloreya-icons'),
               'icon icon-technology' => array('group' => 'gloreya-icons'),
               'icon icon-coins-1' => array('group' => 'gloreya-icons'),
               'icon icon-coins' => array('group' => 'gloreya-icons'),
               'icon icon-left-arrow' => array('group' => 'gloreya-icons'),
               'icon icon-bank' => array('group' => 'gloreya-icons'),
               'icon icon-calculator' => array('group' => 'gloreya-icons'),
               'icon icon-chart1' => array('group' => 'gloreya-icons'),
               'icon icon-chart2' => array('group' => 'gloreya-icons'),
               'icon icon-checked' => array('group' => 'gloreya-icons'),
               'icon icon-clock2' => array('group' => 'gloreya-icons'),
               'icon icon-comment' => array('group' => 'gloreya-icons'),
               'icon icon-comments' => array('group' => 'gloreya-icons'),
               'icon icon-consult' => array('group' => 'gloreya-icons'),
               'icon icon-consut2' => array('group' => 'gloreya-icons'),
               'icon icon-deal' => array('group' => 'gloreya-icons'),
               'icon icon-download2' => array('group' => 'gloreya-icons'),
               'icon icon-envelope2' => array('group' => 'gloreya-icons'),
               'icon icon-euro' => array('group' => 'gloreya-icons'),
               'icon icon-folder' => array('group' => 'gloreya-icons'),
               'icon icon-invest' => array('group' => 'gloreya-icons'),
               'icon icon-loan' => array('group' => 'gloreya-icons'),
               'icon icon-map-marker1' => array('group' => 'gloreya-icons'),
               'icon icon-mutual-fund' => array('group' => 'gloreya-icons'),
               'icon icon-percent' => array('group' => 'gloreya-icons'),
               'icon icon-phone2' => array('group' => 'gloreya-icons'),
               'icon icon-pie-chart1' => array('group' => 'gloreya-icons'),
               'icon icon-play' => array('group' => 'gloreya-icons'),
               'icon icon-left-arrow2' => array('group' => 'gloreya-icons'),
               'icon icon-savings' => array('group' => 'gloreya-icons'),
               'icon icon-search1' => array('group' => 'gloreya-icons'),
               'icon icon-tag1' => array('group' => 'gloreya-icons'),
               'icon icon-tags' => array('group' => 'gloreya-icons'),
               'icon icon-tax' => array('group' => 'gloreya-icons'),
               'icon icon-quote11' => array('group' => 'gloreya-icons'),
               'icon icon-right-arrow2' => array('group' => 'gloreya-icons'),
				),
			),
		);
	}
