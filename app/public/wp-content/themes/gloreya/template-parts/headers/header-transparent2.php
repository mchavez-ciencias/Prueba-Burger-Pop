...
// top settings
   $gloreya_header_topbar_settings   = gloreya_option('header_top_bar_settings');
   $gloreya_top_show                 = $gloreya_header_topbar_settings['header_topbar_show'];
   $gloreya_header_topbar_address    = $gloreya_header_topbar_settings['header_topbar_address'];
   $gloreya_header_topbar_contact    = $gloreya_header_topbar_settings['header_topbar_contact'];
   ...
   $gloreya_shop_btn_show = 'no';
	...
	$gloreya_header_topbar_contact = esc_html__(' +123-456-7899 ','gloreya');
	$gloreya_header_topbar_address = esc_html__('85 Bay Meadows Drive, GA 30188, United States ','gloreya');
   $gloreya_top_show = 'no';
...
<!-- header nav start-->
<header id="header" class="header header-transparent nav-classic-transparent <?php echo esc_attr($gloreya_header_nav_sticky=='yes'?'navbar-sticky':''); ?>">
