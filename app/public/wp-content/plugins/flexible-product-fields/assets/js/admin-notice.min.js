jQuery(document).ready(function(){var notice_selector='[data-notice="fpf-admin-notice"]';var button_close_selector=notice_selector+' .notice-dismiss';var button_hide_selector=notice_selector+' [data-notice-button]';var notice=document.querySelector(notice_selector);if(!notice){return}
