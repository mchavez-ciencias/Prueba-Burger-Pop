...
import {SortableListOptions, SortableListRules} from "./sortable.jsx";
...
export default class FPF_Field extends React.Component {
	...
	constructor(props) {
		...
		this.onChangeTooltip = this.onChangeTooltip.bind(this);
		this.onChangeValueMin = this.onChangeValueMin.bind(this);
		this.onChangeValueMax = this.onChangeValueMax.bind(this);
		this.onChangeValueStep = this.onChangeValueStep.bind(this);
				...
				<div className="fpf-field-inputs" style={showHide}>
					...
					{  fpf_field_types[this.state.data.type]['is_available'] ?
						<table className="fpf-table fpf-table-field-properies">
							...
							{  fpf_field_types[this.state.data.type]['has_css_class'] ?
								<tr className="fpf-field">
									<td className="fpf-label">
										<label
							...
							{  fpf_field_types[this.state.data.type]['has_tooltip'] ?
								<tr className="fpf-field">
									<td className="fpf-label">
										<label
											htmlFor={"field_tooltip_" + this.state.id}>{fpf_admin.field_tooltip_label}</label>
									</td>

									<td className="fpf-input">
										<input type="text" className="fpf-field-tooltip"
							...
							{  fpf_field_types[this.state.data.type]['has_value_min'] ?
								<tr className="fpf-field">
									<td className="fpf-label">
										<label
											htmlFor={"field_value_min_" + this.state.id}>{fpf_admin.field_value_min_label}</label>
									</td>

									<td className="fpf-input">
										<input type="number" step="any" className="fpf-field-value-min"
							...
							{  fpf_field_types[this.state.data.type]['has_value_max'] ?
								<tr className="fpf-field">
									<td className="fpf-label">
										<label
											htmlFor={"field_value_max_" + this.state.id}>{fpf_admin.field_value_max_label}</label>
									</td>

									<td className="fpf-input">
										<input type="number" step="any" className="fpf-field-value-max"
							...
							{  fpf_field_types[this.state.data.type]['has_value_step'] ?
								<tr className="fpf-field">
									<td className="fpf-label">
										<label
											htmlFor={"field_value_step_" + this.state.id}>{fpf_admin.field_value_step_label}</label>
									</td>

									<td className="fpf-input">
										<input type="number" step="any" className="fpf-field-value-step"
							...
							{  fpf_field_types[this.state.data.type]['has_date_format'] ?
								<tr className="fpf-field">
									<td className="fpf-label">
										<label
							...
							{  fpf_field_types[this.state.data.type]['has_days_before'] ?
								<tr className="fpf-field">
									<td className="fpf-label">
										<label
							...
							{  fpf_field_types[this.state.data.type]['has_days_after'] ?
								<tr className="fpf-field">
									<td className="fpf-label">
										<label
