...
class Flexible_Product_Fields_Plugin extends VendorFPF\WPDesk\PluginBuilder\Plugin\AbstractPlugin implements VendorFPF\WPDesk\PluginBuilder\Plugin\HookableCollection {
		...
		if ( isset( $screen ) && ( 'edit-fpf_fields' === $screen->id || 'fpf_fields' === $screen->id ) ) {
			...
			wp_localize_script( 'fpf_admin', 'fpf_admin',
				array(
					...
					'tags_label'                     => __( 'Select tags', 'flexible-product-fields' ),
					...
					'field_tooltip_label'            => __( 'Tooltip', 'flexible-product-fields' ),
					'field_value_min_label'          => __( 'Min value', 'flexible-product-fields' ),
					'field_value_max_label'          => __( 'Max value', 'flexible-product-fields' ),
					'field_value_step_label'         => __( 'Step value', 'flexible-product-fields' ),
					...
					'option_image_upload'            => __( 'Upload Image', 'flexible-product-fields' ),
					'option_image_upload_popup'      => __( 'Upload image as option label', 'flexible-product-fields' ),
					...
					'fields_adv_link'                => esc_url( apply_filters( 'flexible_product_fields/short_url', '#', 'fpf-settings-field-type' ) ),
					...
					'assign_to_adv_link'             => esc_url( apply_filters( 'flexible_product_fields/short_url', '#', 'fpf-settings-option-group-assign' ) ),
					...
					'menu_order_adv_link'            => esc_url( apply_filters( 'flexible_product_fields/short_url', '#', 'fpf-settings-option-group-order' ) ),
					'price_adv'                      => __( 'Price fields are available in PRO version.', 'flexible-product-fields' ),
					'price_adv_link'                 => esc_url( apply_filters( 'flexible_product_fields/short_url', '#', 'fpf-settings-option-field-price' ) ),
					...
					'logic_adv_link'                 => esc_url( apply_filters( 'flexible_product_fields/short_url', '#', 'fpf-settings-option-field-conditional-logic' ) ),
	...
	public function links_filter( $links ) {
		$plugin_links = array(
			...
			'<a href="' . esc_url( apply_filters( 'flexible_product_fields/short_url', '#', 'fpf-settings-row-action-support' ) ) . '" target="_blank">' . __( 'Support', 'flexible-product-fields' ) . '</a>',
		);

		if ( ! wpdesk_is_plugin_active( 'flexible-product-fields-pro/flexible-product-fields-pro.php' ) ) {
			$plugin_links[] = '<a href="' . esc_url( apply_filters( 'flexible_product_fields/short_url', '#', 'fpf-settings-row-action-upgrade' ) ) . '" target="_blank" style="color:#d64e07;font-weight:bold;">' . __( 'Upgrade', 'flexible-product-fields' ) . '</a>';
		}
