...
use VendorFPF\Monolog\Handler\StreamHandler;
use Psr\Log\LoggerInterface;
use VendorFPF\Psr\Log\InvalidArgumentException;
use Exception;
/**
 * Monolog log channel
 *
...
class Logger implements \Psr\Log\LoggerInterface, \VendorFPF\Monolog\ResettableInterface
{
     ...
     * @return $this
     */
    public function pushHandler(\VendorFPF\Monolog\Handler\HandlerInterface $handler)
    {
    ...
    {
        if (!$this->handlers) {
            $this->pushHandler(new \VendorFPF\Monolog\Handler\StreamHandler('php://stderr', static::DEBUG));
        }
    ...
    public static function getLevelName($level)
    {
        if (!isset(static::$levels[$level])) {
            throw new \VendorFPF\Psr\Log\InvalidArgumentException('Level "' . $level . '" is not defined, use one of: ' . \implode(', ', \array_keys(static::$levels)));
        }
