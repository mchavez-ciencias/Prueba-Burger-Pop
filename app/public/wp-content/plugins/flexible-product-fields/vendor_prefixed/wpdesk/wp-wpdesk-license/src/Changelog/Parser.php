...
namespace VendorFPF\WPDesk\License\Changelog;

use ArrayObject;
use VendorFPF\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \VendorFPF\WPDesk\License\Changelog\Parser\Line($line);
