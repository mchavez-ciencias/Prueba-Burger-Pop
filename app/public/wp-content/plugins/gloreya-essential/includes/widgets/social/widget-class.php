 ...
 * social widget
 */
class Gloreya_Social extends WP_Widget {

	function __construct() {
		$widget_opt = array(
			'classname'		 => 'gloreya-widget',
			'description'	 => esc_html__('Gloreya Social','gloreya-essential')
		);

		parent::__construct( 'xs-social', esc_html__( 'Gloreya social', 'gloreya-essential' ), $widget_opt );
	}
	...
	function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'Social', 'gloreya-essential' );
		}
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook:', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'google' ) ); ?>"><?php esc_html_e( 'Google Plus', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest' ) ); ?>"><?php esc_html_e( 'Pinterest', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'youtube' ) ); ?>"><?php esc_html_e( 'Instagram', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'behance', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'flickr' ) ); ?>"><?php esc_html_e( 'flickr', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'github' ) ); ?>"><?php esc_html_e( 'github', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud' ) ); ?>"><?php esc_html_e( 'soundcloud', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'skype' ) ); ?>"><?php esc_html_e( 'skype', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'stumbleupon' ) ); ?>"><?php esc_html_e( 'stumbleupon', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'tumblr' ) ); ?>"><?php esc_html_e( 'tumblr', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo' ) ); ?>"><?php esc_html_e( 'vimeo', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vine' ) ); ?>"><?php esc_html_e( 'vine', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vk' ) ); ?>"><?php esc_html_e( 'vk', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'xing' ) ); ?>"><?php esc_html_e( 'xing', 'gloreya-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'yelp' ) ); ?>"><?php esc_html_e( 'yelp', 'gloreya-essential' ).':'; ?></label>
