<?php
/*
* Plugin Name: Gloreya Essentials
* License - GNU/GPL V2 or Later
* Description: This is a required plugin for gloreya theme.
* Version: 1.4
* text domain: gloreya-essential
*/
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
// Add language
add_action( 'init', 'gloreya_language_load' );
function gloreya_language_load(){
    $plugin_dir = basename(dirname(__FILE__))."/languages/";
    load_plugin_textdomain( 'gloreya-essential', false, $plugin_dir );
}

// main class
class Gloreya_Essentials_Includes {
	...
	public static function include_widget( $widget_dir ) {
		...
		register_widget( 'Gloreya_' . self::dirname_to_classname( $widget_dir ) );
	}
...
Gloreya_Essentials_Includes::init();
