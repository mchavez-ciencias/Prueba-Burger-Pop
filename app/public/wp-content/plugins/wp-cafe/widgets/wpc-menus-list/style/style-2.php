...
foreach ($products as $product) { 
    $permalink = ( $title_link_show == 'yes' ) ?  get_permalink($product->get_id()) : '#';
     Wpc_Widget_Template::wpc_food_menu_list_template_two($show_thumbnail,$permalink, $wpc_cart_button, $unique_id, $product, $class,$show_item_status,$wpc_show_desc,$wpc_desc_limit );
